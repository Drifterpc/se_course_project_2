...
import de.rampro.activitydiary.bean.HistoryBean;
import de.rampro.activitydiary.bean.LaoHuangliBean;
...
//        获取日历对象
        ...
        mainLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(HistoryTodayActivity.this, HistoryDescActivity.class);
                if (position != 0) {
